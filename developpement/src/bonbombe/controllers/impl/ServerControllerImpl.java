...
public class ServerControllerImpl implements Serializable, ServerController {
	 ...
	 */
	public void rejoindreJeu(String _login, String _nomJeu) throws RemoteException, JeuPleinException, JeuEnCoursException{
		Jeu jeu = listeJeux.get(_nomJeu);
		if(jeu.getStatut().equals(Statut.ENCOURS)){
			throw new JeuEnCoursException("Ce jeu est en cours");
		}else{
