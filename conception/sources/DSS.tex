...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.4]{Image/DSS_creer.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.3]{Image/DSS_rejoindreJeu.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.3]{Image/DSS_lancer.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.20]{Image/DSS_jouer.pdf}
	\caption{DSS Rejoindre un Jeu}
\end{figure}
\newpage
...
\begin{figure}[h!]
	\centering 
	\includegraphics[scale=0.4]{Image/DSS_terminer.pdf}
